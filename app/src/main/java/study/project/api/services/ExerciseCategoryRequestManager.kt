...
class ExerciseCategoryRequestManager : ApiRequestManager<ExerciseCategoryResponse> {
    override fun getId(id: Int): ExerciseCategoryResponse.Results {
        return getUrlObject(
            URL("$API_EXERCISE_CATEGORY_URL$id/$FORMAT_JSON"),
            ExerciseCategoryResponse.Results::class.java
        )
    }
    ...
    override fun getAll(): MutableCollection<ExerciseCategoryResponse> {
        ...
        var exerciseCategoryResponse = ExerciseCategoryResponse(
            null,
            API_EXERCISE_CATEGORY_URL + FORMAT_JSON,
            null,
            arrayListOf()
        )
        do {
            exerciseCategoryResponse = getUrlObject(
                URL(exerciseCategoryResponse.next),
                ExerciseCategoryResponse::class.java
            )
